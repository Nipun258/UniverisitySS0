        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                @role('Super-Admin')
                <li class="nav-item">
                    <a href="#" class="nav-link {{ $prefix == '/oauth-clients'? 'active': '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        @can('oauth.client.index')
                        <li class="nav-item">
                            <a href="{{ route('oauth.client.index') }}" class="nav-link {{ $route == 'oauth.client.index'? 'active': '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Client List</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('oauth.client.create') }}" class="nav-link {{ $route == 'oauth.client.create'? 'active': '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add Client</p>
                            </a>
                        </li>
